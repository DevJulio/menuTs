...
const cardProps: TCardProps[] = [
    {
        icon: ideia,
        title: "Vá  muito além do obvio",
        text: "Muito mais que um cardápio digital, é a extenção do seu estabelecimento! seu cardápio, seu site!",
    ...
    },
    {
        ...
        icon: easy,
        title: "Leve e muito fácil de usar",
        text: "Muito mais que um cardápio digital! Funciona na maioria dos dispositivos sem problemas é extremamente leve e modular.",
        mainColor: theme.colors.white.normal,
        auxColor: theme.colors.red.normal,
        textColor: theme.colors.black.normal,
        customWidth: "10vw"
